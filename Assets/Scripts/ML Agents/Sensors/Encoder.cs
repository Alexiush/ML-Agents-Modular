...
public abstract class Encoder
{
    ...
    public abstract string Compile(CompilationContext compilationContext, InplaceArray<int> shape, string input);
    public abstract InplaceArray<int> GetShape(InplaceArray<int> shape);
}

[System.Serializable]
public class IdentityEncoder : Encoder
{
    public override string Compile(CompilationContext compilationContext, InplaceArray<int> shape, string input)
    {
        return input;
    }

    public override InplaceArray<int> GetShape(InplaceArray<int> shape)
    {
        return shape;
    }
}
...
public class LinearEncoder : Encoder
{
    ...
    public override InplaceArray<int> GetShape(InplaceArray<int> shape)
    {
        return new InplaceArray<int>(HiddenSize);
    }
}
